...
EquipmentPropertiesOrder = {
  ...
  [2] = {
    ...
    order = {
      ...
      [10] = {
        name = "{sym}{val}#Evasi\195\179n perfecta",
        func = FunctionPreset.IncStat,
        val = ValuePreset.ExtParam,
  ...
  [3] = {
    ...
    order = {
      [1] = {
        name = "{sym}{val}%#Da\195\177o a distancia larga",
        func = {
      ...
      [2] = {
        name = "{sym}{val}%#Da\195\177o f\195\173sico",
        func = {
      ...
      [3] = {
        name = "{sym}{val}%#Da\195\177o cr\195\173tico",
        func = {
          "AddDamage_CRI",
          "SubDamage_CRI"
        },
      ...
      [4] = {
        name = "{sym}{val}%#Da\195\177o a enemigos Peque\195\177os",
      ...
      [5] = {
        name = "{sym}{val}%#Da\195\177o a enemigos Medianos",
        func = FunctionPreset.IncDmgByUnitSize,
        val = {
          [3] = Operation.ADD
        },
      ...
      [6] = {
        name = "{sym}{val}%#Da\195\177o a enemigos Grandes",
        func = FunctionPreset.IncDmgByUnitSize,
        val = {
          [3] = Operation.ADD
        },
      ...
      [7] = {
        name = "{sym}{val}%#Da\195\177o a enemigos Normales",
      ...
      [8] = {
        name = "{sym}{val}%#Da\195\177o a enemigos Jefes",
        func = FunctionPreset.IncDmgByUnitClass,
        val = {
          [3] = Operation.ADD
        },
      ...
      [10] = {
        name = "{sym}{val}%#Da\195\177o f\195\173sico recibido",
        func = {
          "SubMeleeAttackDamage",
          "AddMeleeAttackDamage"
        },
      ...
      [11] = {
        name = "{sym}{val}%#Resistencia cr\195\173tica",
        func = {
          "SubDamage_CRI",
          "AddDamage_CRI"
        },
      ...
      [12] = {
        name = "{sym}{val}%#Resis. f\195\173sica a enemigos Peque\195\177os",
      ...
      [13] = {
        name = "{sym}{val}%#Resist. f\195\173sica a enemigos Medianos",
        func = FunctionPreset.DecDmgByUnitSize,
        val = {
          [3] = Operation.ADD
        },
      ...
      [14] = {
        name = "{sym}{val}%#Resist. f\195\173sica a enemigos Grandes",
        func = FunctionPreset.DecDmgByUnitSize,
        val = {
          [3] = Operation.ADD
        },
      ...
      [15] = {
        name = "{sym}{val}%#Resis. m\195\161gica a enemigos Peque\195\177os",
      ...
      [16] = {
        name = "{sym}{val}%#Resist. m\195\161gica a enemigos Medianos",
        func = FunctionPreset.DecMDmgByUnitSize,
        val = {
          [3] = Operation.ADD
        },
      ...
      [17] = {
        name = "{sym}{val}%#Resist. m\195\161gica a enemigos Grandes",
        func = FunctionPreset.DecMDmgByUnitSize,
        val = {
          [3] = Operation.ADD
        },
      ...
      [24] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos Peque\195\177os",
      ...
      [25] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos Medianos",
        func = FunctionPreset.IncMDmgByUnitSize,
        val = {
          [3] = Operation.ADD
        },
      ...
      [26] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos Grandes",
        func = FunctionPreset.IncMDmgByUnitSize,
        val = {
          [3] = Operation.ADD
        },
      ...
      [27] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos Normales",
      ...
      [28] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos Jefes",
        func = FunctionPreset.IncMDmgByUnitClass,
        val = {
          [2] = Operation.ADD
        },
  ...
  [4] = {
    ...
    order = {
      [1] = {
        name = "{sym}{val}%#Da\195\177o f\195\173sico a todas las propiedades",
      ...
      [2] = {
        name = "{sym}{val}%#Da\195\177o f\195\173sico a enemigos de Fuego",
        func = FunctionPreset.IncDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [3] = {
        name = "{sym}{val}%#Da\195\177o f\195\173sico a enemigos de Agua",
        func = FunctionPreset.IncDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [4] = {
        name = "{sym}{val}%#Da\195\177o f\195\173sico a enemigos de Tierra",
        func = FunctionPreset.IncDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [5] = {
        name = "{sym}{val}%#Da\195\177o f\195\173sico a enemigos de Viento",
        func = FunctionPreset.IncDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [6] = {
        name = "{sym}{val}%#Da\195\177o f\195\173sico a enemigos de Veneno",
        func = FunctionPreset.IncDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [7] = {
        name = "{sym}{val}%#Da\195\177o f\195\173sico a enemigos de Sombra",
        func = FunctionPreset.IncDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [8] = {
        name = "{sym}{val}%#Da\195\177o f\195\173sico a enemigos Sagrados",
        func = FunctionPreset.IncDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [9] = {
        name = "{sym}{val}%#Da\195\177o f\195\173sico a enemigos Neutrales",
        func = FunctionPreset.IncDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [10] = {
        name = "{sym}{val}%#Da\195\177o f\195\173sico a enemigos Fantasma",
        func = FunctionPreset.IncDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [11] = {
        name = "{sym}{val}%#Da\195\177o f\195\173sico a enemigos Muertos vivientes",
        func = FunctionPreset.IncDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [12] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a todas las propiedades",
      ...
      [13] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos de Fuego",
        func = FunctionPreset.IncMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [14] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos de Agua",
        func = FunctionPreset.IncMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [15] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos de Tierra",
        func = FunctionPreset.IncMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [16] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos de Viento",
        func = FunctionPreset.IncMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [17] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos de Veneno",
        func = FunctionPreset.IncMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [18] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos de Sombra",
        func = FunctionPreset.IncMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [19] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos Sagrados",
        func = FunctionPreset.IncMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [20] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos Neutrales",
        func = FunctionPreset.IncMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [21] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos Fantasma",
        func = FunctionPreset.IncMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [22] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos Muertos vivientes",
        func = FunctionPreset.IncMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [23] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico con todas las propiedades",
      ...
      [24] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico con propiedad Fuego",
        func = FunctionPreset.IncDmgBySkillProp,
        val = {
          [2] = Operation.ADD
        },
      ...
      [25] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico con propiedad Agua",
        func = FunctionPreset.IncDmgBySkillProp,
        val = {
          [2] = Operation.ADD
        },
      ...
      [26] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico con propiedad Tierra",
        func = FunctionPreset.IncDmgBySkillProp,
        val = {
          [2] = Operation.ADD
        },
      ...
      [27] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico con propiedad Viento",
        func = FunctionPreset.IncDmgBySkillProp,
        val = {
          [2] = Operation.ADD
        },
      ...
      [28] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico con propiedad Veneno",
        func = FunctionPreset.IncDmgBySkillProp,
        val = {
          [2] = Operation.ADD
        },
      ...
      [29] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico con propiedad Sombra",
        func = FunctionPreset.IncDmgBySkillProp,
        val = {
          [2] = Operation.ADD
        },
      ...
      [30] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico con propiedad Sagrado",
        func = FunctionPreset.IncDmgBySkillProp,
        val = {
          [2] = Operation.ADD
        },
      ...
      [31] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico con propiedad Neutral",
        func = FunctionPreset.IncDmgBySkillProp,
        val = {
          [2] = Operation.ADD
        },
      ...
      [32] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico con propiedad Fantasma",
        func = FunctionPreset.IncDmgBySkillProp,
        val = {
          [2] = Operation.ADD
        },
      ...
      [33] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico con propiedad Muerto viviente",
        func = FunctionPreset.IncDmgBySkillProp,
        val = {
          [2] = Operation.ADD
        },
      ...
      [35] = {
        name = "{sym}{val}%#Resistencia f\195\173sica a todas las propiedades",
      ...
      [46] = {
        name = "{sym}{val}%#Resistencia f\195\173sica a enemigos de todas las propiedades",
      ...
      [57] = {
        name = "{sym}{val}%#Resistencia m\195\161gica a enemigos de todas las propiedades",
      ...
      [58] = {
        name = "{sym}{val}%#Resistencia m\195\161gica a enemigos de Fuego",
        func = FunctionPreset.DecMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [59] = {
        name = "{sym}{val}%#Resistencia m\195\161gica a enemigos de Agua",
        func = FunctionPreset.DecMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [60] = {
        name = "{sym}{val}%#Resistencia m\195\161gica a enemigos de Tierra",
        func = FunctionPreset.DecMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [61] = {
        name = "{sym}{val}%#Resistencia m\195\161gica a enemigos de Viento",
        func = FunctionPreset.DecMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [62] = {
        name = "{sym}{val}%#Resistencia m\195\161gica a enemigos de Veneno",
        func = FunctionPreset.DecMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [63] = {
        name = "{sym}{val}%#Resistencia m\195\161gica a enemigos de Sombra",
        func = FunctionPreset.DecMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [64] = {
        name = "{sym}{val}%#Resistencia m\195\161gica a enemigos Sagrados ",
        func = FunctionPreset.DecMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [65] = {
        name = "{sym}{val}%#Resistencia m\195\161gica a enemigos Neutrales ",
        func = FunctionPreset.DecMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [66] = {
        name = "{sym}{val}%#Resistencia m\195\161gica a enemigos Fantasmas",
        func = FunctionPreset.DecMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
      ...
      [67] = {
        name = "{sym}{val}%#Resistencia m\195\161gica a enemigos Muerto vivientes ",
        func = FunctionPreset.DecMDmgByUnitProp,
        val = {
          [3] = Operation.ADD
        },
  ...
  [5] = {
    ...
    order = {
      [1] = {
        name = "{sym}{val}%#\"Da\195\177o a enemigos de todas las razas",
      ...
      [2] = {
        name = "{sym}{val}%#Da\195\177o a enemigos de raza Planta",
        func = FunctionPreset.IncDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [3] = {
        name = "{sym}{val}%#Da\195\177o a enemigos de raza Muerto viviente",
        func = FunctionPreset.IncDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [4] = {
        name = "{sym}{val}%#Da\195\177o a enemigos de raza Amorfo",
        func = FunctionPreset.IncDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [5] = {
        name = "{sym}{val}%#Da\195\177o a enemigos de raza \195\129ngel",
        func = FunctionPreset.IncDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [6] = {
        name = "{sym}{val}%#Da\195\177o a enemigos de raza Drag\195\179n",
        func = FunctionPreset.IncDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [7] = {
        name = "{sym}{val}%#Da\195\177o a enemigos de raza Pez",
        func = FunctionPreset.IncDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [8] = {
        name = "{sym}{val}%#Da\195\177o a enemigos de raza Insecto",
        func = FunctionPreset.IncDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [9] = {
        name = "{sym}{val}%#Da\195\177o a enemigos de raza Bestia",
        func = FunctionPreset.IncDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [10] = {
        name = "{sym}{val}%#Da\195\177o a enemigos de raza Demonio",
        func = FunctionPreset.IncDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [11] = {
        name = "{sym}{val}%#Da\195\177o a enemigos de raza Semihumano",
        func = FunctionPreset.IncDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [12] = {
        name = "{sym}{val}%#Da\195\177o f\195\173sico a jugador humano",
        func = FunctionPreset.IncDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [22] = {
        name = "{sym}100%#Elude de DEF en enemigos de raza \195\129ngel",
        func = FunctionPreset.IgnoreDefByUnitRace,
        val = {
          [0] = Operation.ONE
        },
      ...
      [23] = {
        name = "{sym}{val}%#Elude de DEF en enemigos de raza \195\129ngel",
        func = FunctionPreset.IgnoreDefRateByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [24] = {
        name = "{sym}100%#Elude de DEF en enemigos de raza Drag\195\179n",
        func = FunctionPreset.IgnoreDefByUnitRace,
        val = {
          [0] = Operation.ONE
        },
      ...
      [25] = {
        name = "{sym}{val}%#Elude de DEF en enemigos de raza Drag\195\179n",
        func = FunctionPreset.IgnoreDefRateByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [40] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos de todas las razas",
      ...
      [41] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos de raza Planta",
        func = FunctionPreset.IncMDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [42] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos de raza Muerto viviente",
        func = FunctionPreset.IncMDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [43] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos de raza Amorfo",
        func = FunctionPreset.IncMDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [44] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos de raza \195\129ngel",
        func = FunctionPreset.IncMDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [45] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos de raza Drag\195\179n",
        func = FunctionPreset.IncMDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [46] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos de raza Pez",
        func = FunctionPreset.IncMDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [47] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos de raza Insecto",
        func = FunctionPreset.IncMDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [48] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos de raza Bestia",
        func = FunctionPreset.IncMDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [49] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos de raza Demonio",
        func = FunctionPreset.IncMDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [50] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a enemigos de raza Semihumano",
        func = FunctionPreset.IncMDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [51] = {
        name = "{sym}{val}%#Da\195\177o m\195\161gico a jugador Humano",
        func = FunctionPreset.IncMDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [57] = {
        name = "{sym}{val}%#Elude de DEFM en enemigos de raza \195\129ngel",
        func = FunctionPreset.IgnoreMDefRateByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [58] = {
        name = "{sym}{val}%#Elude de DEFM en enemigos de raza Drag\195\179n",
        func = FunctionPreset.IgnoreMDefRateByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [66] = {
        name = "{sym}{val}#CR\195\141T en enemigos Amorfos",
      ...
      [67] = {
        name = "{sym}{val}#CR\195\141T en enemigos Muerto viviente",
        func = FunctionPreset.IncCriByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [68] = {
        name = "{sym}{val}#CR\195\141T en enemigos Bestia",
        func = FunctionPreset.IncCriByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [69] = {
        name = "{sym}{val}#CR\195\141T en enemigos Planta",
        func = FunctionPreset.IncCriByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [70] = {
        name = "{sym}{val}#CR\195\141T en enemigos Insecto",
        func = FunctionPreset.IncCriByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [71] = {
        name = "{sym}{val}#CR\195\141T en enemigos Pez",
        func = FunctionPreset.IncCriByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [72] = {
        name = "{sym}{val}#CR\195\141T en enemigos Demonio",
        func = FunctionPreset.IncCriByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [73] = {
        name = "{sym}{val}#CR\195\141T en enemigos Semihumano",
        func = FunctionPreset.IncCriByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [74] = {
        name = "{sym}{val}#CR\195\141T en enemigos \195\129ngel",
        func = FunctionPreset.IncCriByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [75] = {
        name = "{sym}{val}#CR\195\141T en enemigos Drag\195\179n",
        func = FunctionPreset.IncCriByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [76] = {
        name = "{sym}{val}#CR\195\141T en jugador Humano",
        func = FunctionPreset.IncCriByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [82] = {
        name = "{sym}{val}%#Resistencia a enemigos de raza \195\129ngel",
        func = FunctionPreset.DecDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [83] = {
        name = "{sym}{val}%#Resistencia a enemigos de raza Drag\195\179n",
        func = FunctionPreset.DecDmgByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [91] = {
        name = "{sym}{val}%#Resistencia f\195\173sica a enemigos de todas las razas",
      ...
      [92] = {
        name = "{sym}{val}%#Resistencia f\195\173sica a enemigos de raza Planta",
        func = FunctionPreset.DecDmgByUnitRaceSelf,
        val = {
          [2] = Operation.ADD
        },
      ...
      [93] = {
        name = "{sym}{val}%#Resistencia f\195\173sica a enemigos de raza Muerto viviente",
        func = FunctionPreset.DecDmgByUnitRaceSelf,
        val = {
          [2] = Operation.ADD
        },
      ...
      [94] = {
        name = "{sym}{val}%#Resistencia f\195\173sica a enemigos de raza Amorfo",
        func = FunctionPreset.DecDmgByUnitRaceSelf,
        val = {
          [2] = Operation.ADD
        },
      ...
      [95] = {
        name = "{sym}{val}%#Resistencia f\195\173sica a enemigos de raza \195\129ngel",
        func = FunctionPreset.DecDmgByUnitRaceSelf,
        val = {
          [2] = Operation.ADD
        },
      ...
      [96] = {
        name = "{sym}{val}%#Resistencia f\195\173sica a enemigos de raza Drag\195\179n",
        func = FunctionPreset.DecDmgByUnitRaceSelf,
        val = {
          [2] = Operation.ADD
        },
      ...
      [97] = {
        name = "{sym}{val}%#Resistencia f\195\173sica a enemigos de raza Pez",
        func = FunctionPreset.DecDmgByUnitRaceSelf,
        val = {
          [2] = Operation.ADD
        },
      ...
      [98] = {
        name = "{sym}{val}%#Resistencia f\195\173sica a enemigos de raza Insecto",
        func = FunctionPreset.DecDmgByUnitRaceSelf,
        val = {
          [2] = Operation.ADD
        },
      ...
      [99] = {
        name = "{sym}{val}%#Resistencia f\195\173sica a enemigos de raza Bestia",
        func = FunctionPreset.DecDmgByUnitRaceSelf,
        val = {
          [2] = Operation.ADD
        },
      ...
      [100] = {
        name = "{sym}{val}%#Resistencia f\195\173sica a enemigos de raza Demonio",
        func = FunctionPreset.DecDmgByUnitRaceSelf,
        val = {
          [2] = Operation.ADD
        },
      ...
      [101] = {
        name = "{sym}{val}%#Resistencia f\195\173sica a enemigos de raza Semihumano",
        func = FunctionPreset.DecDmgByUnitRaceSelf,
        val = {
          [2] = Operation.ADD
        },
      ...
      [102] = {
        name = "{sym}{val}%#Resistencia f\195\173sica a jugador Humano",
        func = FunctionPreset.DecDmgByUnitRaceSelf,
        val = {
          [2] = Operation.ADD
        },
      ...
      [108] = {
        name = "{sym}{val}%#Elude la RES en enemigos de raza \195\129ngel",
        func = FunctionPreset.IgnoreResRateByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [109] = {
        name = "{sym}{val}%#Elude la RES en enemigos de raza Drag\195\179n",
        func = FunctionPreset.IgnoreResRateByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [121] = {
        name = "{sym}{val}%#Elude la RESM en enemigos de raza \195\129ngel",
        func = FunctionPreset.IgnoreMResRateByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [122] = {
        name = "{sym}{val}%#Elude la RESM en enemigos de raza Drag\195\179n",
        func = FunctionPreset.IgnoreMResRateByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [134] = {
        name = "{sym}{val}%#EXP obtenida de monstruo de raza \195\129ngel",
        func = FunctionPreset.IncExpByUnitRace,
        val = {
          [2] = Operation.ADD
        },
      ...
      [135] = {
        name = "{sym}{val}%#EXP obtenida de monstruo de raza Drag\195\179n",
        func = FunctionPreset.IncExpByUnitRace,
        val = {
          [2] = Operation.ADD
        },
  ...
  [7] = {
    ...
    order = {
      [1] = {
        name = "{sym}{val}%#Tasa de recuperaci\195\179n de curaci\195\179n de habilidades",
        func = {
          "AddHealValue",
          "SubHealValue"
        },
      ...
      [2] = {
        name = "{sym}{val}%#Tasa de recuperaci\195\179n recibida",
        func = {
      ...
      [4] = {
        name = "{sym}{val}%#Posibilidad de absorber {sep}% del da\195\177o f\195\173sico como PV",
      ...
      [5] = {
        name = "{sym}{val}%#Posibilidad de absorber {sep}% del da\195\177o f\195\173sico como PM",
      ...
      [8] = {
        name = "{sym}{val}%#Reflejo de da\195\177o",
        func = {
      ...
      [9] = {
        name = "Recupera el 100\194\160% del da\195\177o perdido por penalizaciones de tama\195\177o {sym}",
        func = {
          "PerfectDamage"
        },
        sym = SymbolPreset.ApplyWord,
      ...
      [12] = {
        name = "Otorga un efecto de penetraci\195\179n a un arma {sym}",
        func = {
          "SetInvestigate"
        },
        sym = SymbolPreset.ApplyWord,
      ...
      [20] = {
        name = "{val}%#Recuperaci\195\179n de PV {sym}",
        func = FunctionPreset.IncStat,
        val = ValuePreset.ExtParam,
      ...
      [21] = {
        name = "{val}%#Recuperaci\195\179n de PM {sym}",
        func = FunctionPreset.IncStat,
        val = ValuePreset.ExtParam,
      ...
      [22] = {
        name = "{val}%#Da\195\177o reflejado recibido {sym}",
        func = {
          "SubReflectTolerace",
          "AddReflectTolerace"
        },
      ...
      [23] = {
        name = "{sym}{val}%#Tasa de ca\195\173da de objetos",
        func = {
